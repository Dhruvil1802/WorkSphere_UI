...
const EmployeeProfile = () => {
  ...
  useEffect(()=>{async function getAllDetails() {
  ...
  useEffect(() => {
    console.log(gereralDetails,education,skills,preferences,experiences,achievements,certifications);
  }, [gereralDetails,education,skills,preferences,experiences,achievements,certifications]);
  ...
  return (
    <div className="profile-container">
      ...
      <div className="profile-left">
        ...
        />
        <h3 className="profile-name">{gereralDetails[0]?.employee_id?.employee_name}</h3>
        <div className="profile-info">
          <p><strong>Gender:</strong> {gereralDetails[0]?.gender}</p>
          <p><strong>Age:</strong> {gereralDetails[0]?.age}</p>
          <p><strong>Address:</strong> {gereralDetails[0]?.address}</p>
          <p><strong>Background:</strong> {gereralDetails[0]?.background}</p> 
        </div>
      </div>
